/**
 * Created by xuexiaowei on 16/9/23.
...
(function (){
  let buildTasks = ['clean', ['sprite'], ['compile', 'copy', 'concat-script', 'concat-style', 'tar', 'precompile']];
  if(env.revision) {
...
// 调试
gulp.task('dev', gulpSequence('detection',['sprite'], ['compile', 'copy', 'concat-script', 'concat-style', 'tar', 'precompile'], 'serve'));
